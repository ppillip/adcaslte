...
<head>
    ...
    <link href="downLinkBySTDStatsGraph.css" rel="stylesheet">
    <script src="downLinkBySTDStatsGraph.js" language="javascript"></script>
...
<div id="wrap">
    <div id="web_container">
        <div id="header">
            ...
            <div id="popup_desc">LTE 용량분석 > LTE 기준 용량분석 > DownLink 통계 그래프</div>
        </div>
        <div id="middle">
            <div id='search_table'>
                <table>
