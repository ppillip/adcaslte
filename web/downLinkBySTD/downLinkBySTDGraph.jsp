...
<head>
    ...
    <link href="downLinkBySTDGraph.css" rel="stylesheet">
    <script src="downLinkBySTDGraph.js" language="javascript"></script>
...
<div id="wrap">
    <div id="web_container">
        <div id="header">
            ...
            <div id="popup_desc">LTE 용량분석 > LTE 기준 용량분석 > DownLink 그래프</div>
        </div>
        <div id="middle">
            <div id='search_table'>
                <table>
