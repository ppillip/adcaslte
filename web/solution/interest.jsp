...
<head>
    ...
    <script src="interest.js" language="javascript"></script>
...
<div id="wrap">
    <div id="web_container">
        <div id="header">
            ...
            <div id="popup_desc">LTE 솔수션 > 관심국소분석 > 관심국소조회</div>
        </div>
        <div id="middle">
            <div id='search_table'>
                <table>
                                ...
                                <tr>
                                    <td style="padding-left:10px;padding-right:10px;padding-bottom:1px;">
                                        <div name="divSearch" ID="divSearch" class="" style="margin-top:0px;padding:0; vertical-align:middle;">
                                            <input type="hidden" name="WORKGROUP_ID" value="INTEREST">
                                            <table border="0">
                                                <colgroup>
                                                    <col width="200px">
                                                    <col width="50px">
...
<div style="width:900px; height:490px;">
    <div style="height:450px; margin:5px;">
        <table id="interestListTable" class="table table-bordered table-hover table-condensed table-striped">
            <colgroup>
                <col width="100px;">
                <col width="230px;">
                <col width="70px;">
