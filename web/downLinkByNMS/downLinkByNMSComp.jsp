...
<head>
    ...
    <link href="downLinkByNMSComp.css" rel="stylesheet">
    <script src="downLinkByNMSComp.js" language="javascript"></script>
...
<div name="divDailyDataPadAfter" id="divDataPadAfter">
    ...
    <table name="dailyDataAfter">
        ...
        <tr style="vertical-align: top; margin: 0 0 0 0; padding: 0 0 0 0;">
            <td><!-- middle left   -->
                <div class="" name="divMiddleLeftAfter" id="divMiddleLeftAfter">
                    <table name="tableMiddleLeftAfter"  id="tableMiddleLeftAfter" class="table table-bordered table-condensed table-striped">
                        <colgroup>
                            <col class="col01">
                            <col class="col02">
                            <col class="col03">
