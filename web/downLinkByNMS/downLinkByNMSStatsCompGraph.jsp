...
<head>
    ...
    <link href="downLinkByNMSStatsCompGraph.css" rel="stylesheet">
    <script src="downLinkByNMSStatsCompGraph.js" language="javascript"></script>
...
<div id="wrap">
    <div id="web_container">
        <div id="header">
            ...
            <div id="popup_desc">LTE 용량분석 > LTE NMS 기반 TP > DownLink 통계 전후비교 그래프</div>
        </div>
        <div id="middle">
            <div id='search_table'>
                <table>
