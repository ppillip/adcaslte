...
<head>
    ...
    <link href="downLinkByQMSStatsGraph.css" rel="stylesheet">
    <script src="downLinkByQMSStatsGraph.js" language="javascript"></script>
                                        ...
                                        <div name="divSearch" ID="divSearch" style="width:1000px;vertical-align:middle;">
                                            <table border="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b>기간</b></td>
                                                    <td>
                                                        <input name="FROMYMD" id="datepicker01" type="text">
                                                        -
                                                        <input name="TOYMD"   id="datepicker02" type="text">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
